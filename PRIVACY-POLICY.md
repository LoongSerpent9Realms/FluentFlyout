...
This Privacy Policy describes how your personal information is handled in PulseFlyout.

### 1. Information We Collect
PulseFlyout does not collect, store, or process any personally identifiable information (PII) such as your name, email address, or precise location. As a background utility application, it does not require any user-specific information to function. 
...
The original project's website is hosted on Cloudflare Pages (https://fluentflyout.com). Cloudflare may collect additional network and HTTP traffic data automatically (see Section 4).

### 2. Telemetry and Usage Data
PulseFlyout collects limited, anonymous telemetry to help us maintain, optimize and improve the application.
...
* **Opt-out:** You can opt out of this anonymous data collection at any time by going to the PulseFlyout Settings menu and disabling "Anonymous Usage Data" under System.
...
*   **Microsoft Store Version:** If you installed PulseFlyout from the Microsoft Store, Microsoft collects standard analytics, including app acquisitions (downloads), active usage sessions, and hardware configuration (e.g., OS version, device type).
